    ...
    <div class="roledata form">
        <div class="tab-content">
            <div id="panel_basic" class="strings tab-pane fade in active">
                ...
                echo $this->Form->input('AccountID', ['options' => $accounts, 'label' => ['class' => 'col-md-3 col-xs-3 control-label']]);
                ...
                echo $this->Form->input('LoginTime', ['disabled' => true, 'label' => ['class' => 'col-md-3 col-xs-3 control-label']]);
                echo $this->Form->input('LogoutTime', ['disabled' => true, 'label' => ['class' => 'col-md-3 col-xs-3 control-label']]);
                ?>
            </div>
            ...
            <div id="panel_additional" class="numbers tab-pane fade in">
                ...
                echo $this->Form->input('CloseSGTime', ['label' => ['class' => 'col-md-3 col-xs-3 control-label']]);
                echo $this->Form->input('GetMallFreeTime', ['label' => ['class' => 'col-md-3 col-xs-3 control-label']]);
                ?>
            </div>
